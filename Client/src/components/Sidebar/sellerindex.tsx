            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === 'SellerECommerce' ||
                            pathname.includes('SellerECommerce')) &&
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                       d="M21.748 8.358l-8-6a2 2 0 00-2.496 0l-8 6A2 2 0 002 9.618v9.764a2 2 0 00.752 1.56l8 6a2 2 0 002.496 0l8-6A2 2 0 0022 19.382V9.618a2 2 0 00-.252-1.26zm-9.748 2.618v9.29l-8-6.19V9.878l8-6.19v7.288zm10 3.1l-8 6.19v-9.29l8-6.19v7.29z"
                        fill="currentColor"
                    />
                  </svg>
                  My Orders
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M10.59 13.41a1 1 0 0 1 0-1.41l2.17-2.17a4 4 0 0 1 5.66 5.66l-2.17 2.17a4 4 0 0 1-5.66-5.66zm5.66-3.18a2 2 0 0 0-2.83 0l-2.17 2.17a2 2 0 1 0 2.83 2.83l2.17-2.17a2 2 0 0 0 0-2.83zM6.17 14.59a4 4 0 0 1 5.66 0l2.17 2.17a4 4 0 0 1-5.66 5.66l-2.17-2.17a4 4 0 0 1 0-5.66zm0-5.66a2 2 0 0 0-2.83 2.83l2.17 2.17a2 2 0 1 0 2.83-2.83l-2.17-2.17a2 2 0 0 0-2.83 0z"
                      fill="currentColor"
                    />
                  </svg>
                  Connections
              ...
              <li>
                <NavLink
                  to="/seller-profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('SellerProfile') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
